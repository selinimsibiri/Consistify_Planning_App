...
class _LogInPageState extends State<LogInPage> {
  ...
  void _tryLogin() async {
    ...
    print(
      "Giriş yapılan email: $email, hash: $hash",
    ); // Debugging: Giriş yapılan email ve hash
  ...
  Future<void> fetchColumns() async {
    try {
      List<String> fetchedColumns =
          await DatabaseHelper.instance.getUsersTableColumns();
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: InkWell(
                    onTap: () {
                      // yönlendirme // BURASI DUZENLENECEK
                      Navigator.push(
                        context,
